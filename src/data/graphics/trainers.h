...
const u32 gTrainerFrontPic_Wally[] = INCBIN_U32("graphics/trainers/front_pics/ethan.4bpp.lz");
const u32 gTrainerPalette_Wally[] = INCBIN_U32("graphics/trainers/front_pics/ethan.gbapal.lz");
